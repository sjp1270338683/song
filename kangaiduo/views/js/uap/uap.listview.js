uap.define("listview", function($, exports, module) {
...
<%}%>\
    ...
    var thinLineTmp = uap.view.template(model_thinLine);
    var groupLineTmp = uap.view.template(model_groupLine);
    var thickLineTmp = uap.view.template(model_thickLine);
    var viewid = 1;
    function isWindows() {
    ...
    Listview.prototype = {
        buildListview : function(data,group) {
            ...
            uap.switchBtn(switchBtns, function(obj, value) {
                var ele = obj.parent();
